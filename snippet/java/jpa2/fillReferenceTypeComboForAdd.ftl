...
<#assign projectSpecificSearchProperty = modelReference.getMetaData("projectspecific.fillComboForAdd", "false")>
<#assign projectSpecificSearch = modelReference.hasMetaData("projectspecific.fillComboForAdd", "true")>
<#if projectSpecificSearch >
  <#assign body>
    <@createBodyUsingJPA2 />
  </#assign>
  ${metafactory.evaluateFreeMarkerSnippet("projectspecific.java.cdi.beans.fillReferenceTypeComboForAdd", body)}
<#else>
  <@createBodyUsingJPA2 />
</#if>
